 ...
 *
 */
public class TemplateTable extends SortableSelectableTable {
...
//		}
	 ...
	 * @return table model.
	 */
	public TemplateTableModel getModel2() {
		return (TemplateTableModel)getModel();
	}
 ...
 *
 */
class TemplateTableModel extends SortableSelectableTableModel implements TableModelListener {
...
//		if (columnIndex == 3) return Boolean.class;
	...
	/**
	 * Applying table model into internal data.
...
//		System.out.println("TemplateTableModel.tableChanged(TableModelEvent) not implemented yet");
