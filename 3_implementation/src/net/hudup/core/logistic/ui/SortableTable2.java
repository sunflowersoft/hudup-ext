...
public class SortableTable2 extends JTable {
     ...
     */
    public SortableTable2(final SortableTableModel2 model) {
        super(model);
        init();
    }
     ...
     */
    protected void init() {
    	SortableTableModel2 model = (SortableTableModel2)getModel();
        ...
        this.headerListener = new SortableTableHeaderListener((SortableTableModel2)model, renderer);
        header.addMouseListener(this.headerListener);
        header.addMouseMotionListener(this.headerListener);

    	((SortableTableModel2)model).sortByColumn(0, true);
    }
    /**
     ...
     *
     */
    public void setSortableModel(final SortableTableModel2 model) {
...
class SortableTableHeaderListener implements MouseListener, MouseMotionListener, Serializable {
    ...
    private SortableTableModel2 model;
     ...
     */
    public SortableTableHeaderListener(final SortableTableModel2 model, 
     ...
     * @param model  the model.
     */
    public void setTableModel(final SortableTableModel2 model) {
        this.model = model;
    }
    ...
    public void mouseReleased(final MouseEvent e) {
        ...
        if (header.getResizingColumn() == null) {  // resizing takes precedence over sorting
            if (this.sortColumnIndex != -1) {
                final SortableTableModel2 model = (SortableTableModel2) header.getTable().getModel();
...
class SortButtonRenderer implements TableCellRenderer, Serializable {
    ...
    public Component getTableCellRendererComponent(final JTable table,
        ...
        final SortableTableModel2 model = (SortableTableModel2) table.getModel();
