 ...
 * <br><br>
 * So this class called {@code database server indicator} is an {@link Indicator} to retrieve a {@link ServerPointer} pointing to a database server such as MySQL and Oracle.
 * 
 * @author Loc Nguyen
 * @version 10.0
 *
 */
public class DbServerIndicator extends Indicator {
