...
/**
 * This class is extended version of power server control panel with improvement.
 * 
 * @author Loc Nguyen
 * @version 1.0
 *
 */
public class ExtendedServer2CP extends ExternalServerCP {
	 ...
	 * @param server specified server.
	 */
	public ExtendedServer2CP(PowerServer server) {
		this(server, null);
	}
...
//		}
	...
	public static void main(String[] args) {
		...
		if (server == null) {
			...
			new ExtendedServer2CP((PowerServer)server, connectInfo);
	}
