...
//		catch (Throwable e) {LogUtil.trace(e);}
		...
		Evaluator evaluator = batchEvaluateGUI.getEvaluator();
		PluginChangedListener pluginChangedListener = evaluator;
		try {
			Service referredService = evaluator.getReferredService();
			if ((referredService != null) && (referredService instanceof PluginChangedListener))
